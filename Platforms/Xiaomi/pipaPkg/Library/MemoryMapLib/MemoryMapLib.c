...
gMemoryDescriptor[] = {
  ...
  {"Uncached Pool",     0x80B00000, 0x01900000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  ...
  {"DXE Heap",          0x93200000, 0x08A00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
  ...
  // Clock Controller MMIO
  {"CLK_CTL",           0x00100000, 0x00200000, AddDev, MMAP_IO, UNCACHEABLE, MmIO, NS_DEVICE},
